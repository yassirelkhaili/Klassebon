-- CreateEnum
CREATE TYPE "turnus" AS ENUM ('WOECHENTLICH', 'MONATLICH', 'JAEHRLICH');
...
-- AddForeignKey
ALTER TABLE "ausgabe" ADD CONSTRAINT "ausgabe_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
